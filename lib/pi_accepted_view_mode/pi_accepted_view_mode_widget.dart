...
import 'pi_accepted_view_mode_model.dart';
export 'pi_accepted_view_mode_model.dart';

class PiAcceptedViewModeWidget extends StatefulWidget {
  const PiAcceptedViewModeWidget({super.key});

  @override
  State<PiAcceptedViewModeWidget> createState() =>
      _PiAcceptedViewModeWidgetState();
}

class _PiAcceptedViewModeWidgetState extends State<PiAcceptedViewModeWidget> {
  late PiAcceptedViewModeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PiAcceptedViewModeModel());
