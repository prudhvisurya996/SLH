...
import 'dont_delete_o_k_model.dart';
export 'dont_delete_o_k_model.dart';

class DontDeleteOKWidget extends StatefulWidget {
  const DontDeleteOKWidget({
    super.key,
    required this.id,
    required this.index,
  });
  ...
  @override
  State<DontDeleteOKWidget> createState() => _DontDeleteOKWidgetState();
}

class _DontDeleteOKWidgetState extends State<DontDeleteOKWidget> {
  late DontDeleteOKModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DontDeleteOKModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final dontDeleteOKPropertyDetailsResponse = snapshot.data!;
                                              ...
                                              child: custom_widgets
                                                ...
                                                imgList: functions
                                                  ...
                                                  MicroserviceAvailabilityAPIsGroup
                                                      .propertyDetailsCall
                                                      .imgesUrls(
                                                    dontDeleteOKPropertyDetailsResponse
                                                        .jsonBody,
                                                  ),
                                                  'NA',
                                                )),
                                                                      ...
                                                                      valueOrDefault<
                                                                        ...
                                                                        '${valueOrDefault<String>(
                                                                          MicroserviceAvailabilityAPIsGroup
                                                                              .propertyDetailsCall
                                                                              .totalGuests(
                                                                                dontDeleteOKPropertyDetailsResponse.jsonBody,
                                                                              )
                                                                              ?.toString(),
                                                                          'NA',
                                                        ...
                                                        itemBuilder: (context,
                                                          ...
                                                          return Container(
                                                            ...
                                                            child:
                                                                UserReviewsWidget(
                                                              key: Key(
                                                                  'Keykhl_${ratingReviewDataIndex}_of_${_model.listViewPagingController1!.itemList!.length}'),
                                                              userName:
                                                                  getJsonField(
                                                                        ...
                                                                        itemBuilder:
                                                                          ...
                                                                          return InkWell(
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              FFAppState().propertyBookingDetails = PropertyBookingDetailsStruct();
