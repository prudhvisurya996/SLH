...
import 'hosted_properties_status_model.dart';
export 'hosted_properties_status_model.dart';

class HostedPropertiesStatusWidget extends StatefulWidget {
  const HostedPropertiesStatusWidget({super.key});

  @override
  State<HostedPropertiesStatusWidget> createState() =>
      _HostedPropertiesStatusWidgetState();
}

class _HostedPropertiesStatusWidgetState
    extends State<HostedPropertiesStatusWidget> {
  late HostedPropertiesStatusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HostedPropertiesStatusModel());
