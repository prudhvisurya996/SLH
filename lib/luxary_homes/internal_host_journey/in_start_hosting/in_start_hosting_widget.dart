...
import 'in_start_hosting_model.dart';
export 'in_start_hosting_model.dart';

class InStartHostingWidget extends StatefulWidget {
  const InStartHostingWidget({super.key});

  @override
  State<InStartHostingWidget> createState() => _InStartHostingWidgetState();
}

class _InStartHostingWidgetState extends State<InStartHostingWidget> {
  late InStartHostingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InStartHostingModel());
