...
import 'host_active_property_component_model.dart';
export 'host_active_property_component_model.dart';

class HostActivePropertyComponentWidget extends StatefulWidget {
  const HostActivePropertyComponentWidget({
    super.key,
    int? myPropCount,
  ...
  @override
  State<HostActivePropertyComponentWidget> createState() =>
      _HostActivePropertyComponentWidgetState();
}

class _HostActivePropertyComponentWidgetState
    extends State<HostActivePropertyComponentWidget> {
  late HostActivePropertyComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HostActivePropertyComponentModel());
