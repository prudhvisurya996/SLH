...
import 'w_active_properties_model.dart';
export 'w_active_properties_model.dart';

class WActivePropertiesWidget extends StatefulWidget {
  const WActivePropertiesWidget({
    super.key,
  ...
  @override
  State<WActivePropertiesWidget> createState() =>
      _WActivePropertiesWidgetState();
}

class _WActivePropertiesWidgetState extends State<WActivePropertiesWidget> {
  late WActivePropertiesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WActivePropertiesModel());
                      ...
                      child: RefreshIndicator(
                        ...
                        child: PagedMasonryGridView<ApiPagingParams,
                          ...
                          builderDelegate: PagedChildBuilderDelegate<dynamic>(
                            ...
                            itemBuilder: (context, _, approvedListWebIndex) {
                              final approvedListWebItem = _model
                                  .staggeredViewPagingController!
                                  .itemList![approvedListWebIndex];
                              return InkWell(
