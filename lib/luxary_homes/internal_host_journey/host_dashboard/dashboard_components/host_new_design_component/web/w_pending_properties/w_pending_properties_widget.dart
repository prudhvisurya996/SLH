...
import 'w_pending_properties_model.dart';
export 'w_pending_properties_model.dart';

class WPendingPropertiesWidget extends StatefulWidget {
  const WPendingPropertiesWidget({
    super.key,
  ...
  @override
  State<WPendingPropertiesWidget> createState() =>
      _WPendingPropertiesWidgetState();
}

class _WPendingPropertiesWidgetState extends State<WPendingPropertiesWidget> {
  late WPendingPropertiesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WPendingPropertiesModel());
                      ...
                      child: RefreshIndicator(
                        ...
                        child: PagedMasonryGridView<ApiPagingParams,
                          ...
                          builderDelegate: PagedChildBuilderDelegate<dynamic>(
                            ...
                            itemBuilder: (context, _, pendingListWebIndex) {
                              final pendingListWebItem = _model
                                  .staggeredViewPagingController!
                                  .itemList![pendingListWebIndex];
                              return InkWell(
