...
import 'w_rejected_properties_model.dart';
export 'w_rejected_properties_model.dart';

class WRejectedPropertiesWidget extends StatefulWidget {
  const WRejectedPropertiesWidget({
    super.key,
  ...
  @override
  State<WRejectedPropertiesWidget> createState() =>
      _WRejectedPropertiesWidgetState();
}

class _WRejectedPropertiesWidgetState extends State<WRejectedPropertiesWidget> {
  late WRejectedPropertiesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WRejectedPropertiesModel());
                      ...
                      child: RefreshIndicator(
                        ...
                        child: PagedMasonryGridView<ApiPagingParams,
                          ...
                          builderDelegate: PagedChildBuilderDelegate<dynamic>(
                            ...
                            itemBuilder: (context, _, rejectedListWebIndex) {
                              final rejectedListWebItem = _model
                                  .staggeredViewPagingController!
                                  .itemList![rejectedListWebIndex];
                              return InkWell(
