...
import 'submission_confirmation_model.dart';
export 'submission_confirmation_model.dart';

class SubmissionConfirmationWidget extends StatefulWidget {
  const SubmissionConfirmationWidget({super.key});

  @override
  State<SubmissionConfirmationWidget> createState() =>
      _SubmissionConfirmationWidgetState();
}

class _SubmissionConfirmationWidgetState
    extends State<SubmissionConfirmationWidget> {
  late SubmissionConfirmationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubmissionConfirmationModel());
