...
import 'tellus_about_your_property_model.dart';
export 'tellus_about_your_property_model.dart';

class TellusAboutYourPropertyWidget extends StatefulWidget {
  const TellusAboutYourPropertyWidget({super.key});

  @override
  State<TellusAboutYourPropertyWidget> createState() =>
      _TellusAboutYourPropertyWidgetState();
}

class _TellusAboutYourPropertyWidgetState
    extends State<TellusAboutYourPropertyWidget> {
  late TellusAboutYourPropertyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TellusAboutYourPropertyModel());

    _model.mobileTitleTextFieldTextController ??= TextEditingController(
        text: FFAppState().internalPropertyHostingDetails.title);
    _model.mobileTitleTextFieldFocusNode ??= FocusNode();

    _model.mobileDescriptionTextFieldTextController ??= TextEditingController(
        text: FFAppState().internalPropertyHostingDetails.description);
    _model.mobileDescriptionTextFieldFocusNode ??= FocusNode();

    _model.webTitleTextFieldTextController ??= TextEditingController(
        text: FFAppState().internalPropertyHostingDetails.title);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final tellusAboutYourPropertyGetPropertyTypesResponse = snapshot.data!;
                                            ...
                                            child: Builder(
                                              builder: (context) {
                                                final propertyTypeList =
                                                    tellusAboutYourPropertyGetPropertyTypesResponse
                                                        .jsonBody
                                                        .toList();
