...
import 'in_tell_us_about_property_copy_model.dart';
export 'in_tell_us_about_property_copy_model.dart';

class InTellUsAboutPropertyCopyWidget extends StatefulWidget {
  const InTellUsAboutPropertyCopyWidget({super.key});

  @override
  State<InTellUsAboutPropertyCopyWidget> createState() =>
      _InTellUsAboutPropertyCopyWidgetState();
}

class _InTellUsAboutPropertyCopyWidgetState
    extends State<InTellUsAboutPropertyCopyWidget> {
  late InTellUsAboutPropertyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InTellUsAboutPropertyCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final inTellUsAboutPropertyCopyGetPropertyTypesResponse =
            snapshot.data!;
                                                ...
                                                child: Builder(
                                                  builder: (context) {
                                                    final propertyTypeList =
                                                        inTellUsAboutPropertyCopyGetPropertyTypesResponse
                                                            .jsonBody
                                                            .toList();
