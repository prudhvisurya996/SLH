...
import 'in_property_summary_model.dart';
export 'in_property_summary_model.dart';

class InPropertySummaryWidget extends StatefulWidget {
  const InPropertySummaryWidget({super.key});

  @override
  State<InPropertySummaryWidget> createState() =>
      _InPropertySummaryWidgetState();
}

class _InPropertySummaryWidgetState extends State<InPropertySummaryWidget> {
  late InPropertySummaryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InPropertySummaryModel());
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      alignment:
                                          AlignmentDirectional(-1.0, -1.0),
                                      child: Text(
                                        '${FFAppState().hostAddressDetail.plotNo}, ${FFAppState().hostAddressDetail.streetAddress}, ${FFAppState().hostAddressDetail.locality}, ${FFAppState().hostAddressDetail.city}, ${FFAppState().hostAddressDetail.state}-${FFAppState().hostAddressDetail.zip}, ${FFAppState().hostAddressDetail.region}.${FFAppState().hostAddressDetail.landmark}',
                                        style: FlutterFlowTheme.of(context)
                                            .headlineMedium
                                            .override(
                                              fontFamily: 'Poppins',
