...
import 'in_address_details_copy_model.dart';
export 'in_address_details_copy_model.dart';

class InAddressDetailsCopyWidget extends StatefulWidget {
  const InAddressDetailsCopyWidget({super.key});

  @override
  State<InAddressDetailsCopyWidget> createState() =>
      _InAddressDetailsCopyWidgetState();
}

class _InAddressDetailsCopyWidgetState
    extends State<InAddressDetailsCopyWidget> {
  late InAddressDetailsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InAddressDetailsCopyModel());
