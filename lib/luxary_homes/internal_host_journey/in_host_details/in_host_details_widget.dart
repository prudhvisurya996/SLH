...
import 'in_host_details_model.dart';
export 'in_host_details_model.dart';

class InHostDetailsWidget extends StatefulWidget {
  const InHostDetailsWidget({
    super.key,
  ...
  @override
  State<InHostDetailsWidget> createState() => _InHostDetailsWidgetState();
}

class _InHostDetailsWidgetState extends State<InHostDetailsWidget> {
  late InHostDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InHostDetailsModel());
