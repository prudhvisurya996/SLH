...
import 'in_submit_confirm_model.dart';
export 'in_submit_confirm_model.dart';

class InSubmitConfirmWidget extends StatefulWidget {
  const InSubmitConfirmWidget({
    super.key,
  ...
  @override
  State<InSubmitConfirmWidget> createState() => _InSubmitConfirmWidgetState();
}

class _InSubmitConfirmWidgetState extends State<InSubmitConfirmWidget> {
  late InSubmitConfirmModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InSubmitConfirmModel());
