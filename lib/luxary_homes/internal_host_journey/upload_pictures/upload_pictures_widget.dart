...
import 'upload_pictures_model.dart';
export 'upload_pictures_model.dart';

class UploadPicturesWidget extends StatefulWidget {
  const UploadPicturesWidget({super.key});

  @override
  State<UploadPicturesWidget> createState() => _UploadPicturesWidgetState();
}

class _UploadPicturesWidgetState extends State<UploadPicturesWidget> {
  late UploadPicturesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadPicturesModel());
                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        'Each image size should be max 500 KB.',
                                    style: TextStyle(
                                      fontSize: 12.0,
                                    ),
                                  )
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                title: Text('Info'),
                                                content: Text(
                                                    'Upload atleast 2 property images !'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: Text('Alert'),
                                                  content: Text(
                                                      'Uploaded property Images should not exceed more than 5.'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
