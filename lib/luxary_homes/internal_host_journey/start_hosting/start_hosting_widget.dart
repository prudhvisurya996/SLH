...
import 'start_hosting_model.dart';
export 'start_hosting_model.dart';

class StartHostingWidget extends StatefulWidget {
  const StartHostingWidget({super.key});

  @override
  State<StartHostingWidget> createState() => _StartHostingWidgetState();
}

class _StartHostingWidgetState extends State<StartHostingWidget> {
  late StartHostingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StartHostingModel());
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                child: Text(
                                                                  'Provide essential details about the property\'s location and the number of guests it can accommodate.',
                                                                  textAlign:
                                                                      TextAlign
                                                                          .start,
                                                                  style: GoogleFonts
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                child: Text(
                                                                  'Add 2 or more photos plus a title and description.',
                                                                  textAlign:
                                                                      TextAlign
                                                                          .start,
                                                                  style: GoogleFonts
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                child: Text(
                                                                  'Choose if you want to start with an experienced guest, set a starting price and publish your listing.',
                                                                  textAlign:
                                                                      TextAlign
                                                                          .start,
                                                                  style: GoogleFonts
