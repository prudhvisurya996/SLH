...
import 'in_property_pending_model.dart';
export 'in_property_pending_model.dart';

class InPropertyPendingWidget extends StatefulWidget {
  const InPropertyPendingWidget({
    super.key,
  ...
  @override
  State<InPropertyPendingWidget> createState() =>
      _InPropertyPendingWidgetState();
}

class _InPropertyPendingWidgetState extends State<InPropertyPendingWidget> {
  late InPropertyPendingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InPropertyPendingModel());
