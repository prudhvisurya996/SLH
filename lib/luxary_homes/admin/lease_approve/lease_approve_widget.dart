...
class _LeaseApproveWidgetState extends State<LeaseApproveWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: MicroserviceAvailabilityAPIsGroup.adminLRListingCall.call(
      ...
      builder: (context, snapshot) {
        ...
        final columnAdminLRListingResponse = snapshot.data!;
        return Column(
          mainAxisSize: MainAxisSize.max,
          children: [
            if (MicroserviceAvailabilityAPIsGroup.adminLRListingCall.totalCount(
                  columnAdminLRListingResponse.jsonBody,
                ) !=
                0)
              Flexible(
                child: Padding(
