...
import 'lease_reject_model.dart';
export 'lease_reject_model.dart';

class LeaseRejectWidget extends StatefulWidget {
  const LeaseRejectWidget({
    super.key,
  ...
  @override
  State<LeaseRejectWidget> createState() => _LeaseRejectWidgetState();
}

class _LeaseRejectWidgetState extends State<LeaseRejectWidget> {
  late LeaseRejectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeaseRejectModel());
                        ...
                        children: [
                          ...
                          if (responsiveVisibility(
                            ...
                            Flexible(
                              child: Builder(
                                builder: (context) {
                                  final rejectPropertyListing = getJsonField(
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount: rejectPropertyListing.length,
                                    itemBuilder:
                                        (context, rejectPropertyListingIndex) {
                                      final rejectPropertyListingItem =
                                          rejectPropertyListing[
                                              rejectPropertyListingIndex];
                                      return Column(
                                        mainAxisSize: MainAxisSize.max,
                                        children: [
                                          Padding(
