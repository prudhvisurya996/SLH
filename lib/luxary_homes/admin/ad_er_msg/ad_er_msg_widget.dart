...
import 'ad_er_msg_model.dart';
export 'ad_er_msg_model.dart';

class AdErMsgWidget extends StatefulWidget {
  const AdErMsgWidget({
    super.key,
  ...
  @override
  State<AdErMsgWidget> createState() => _AdErMsgWidgetState();
}

class _AdErMsgWidgetState extends State<AdErMsgWidget> {
  late AdErMsgModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdErMsgModel());
