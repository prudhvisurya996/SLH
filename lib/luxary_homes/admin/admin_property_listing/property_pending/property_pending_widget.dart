...
import 'property_pending_model.dart';
export 'property_pending_model.dart';

class PropertyPendingWidget extends StatefulWidget {
  const PropertyPendingWidget({
    super.key,
  ...
  @override
  State<PropertyPendingWidget> createState() => _PropertyPendingWidgetState();
}

class _PropertyPendingWidgetState extends State<PropertyPendingWidget> {
  late PropertyPendingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PropertyPendingModel());
