...
import 'reason_for_reject_form_model.dart';
export 'reason_for_reject_form_model.dart';

class ReasonForRejectFormWidget extends StatefulWidget {
  const ReasonForRejectFormWidget({
    super.key,
  ...
  @override
  State<ReasonForRejectFormWidget> createState() =>
      _ReasonForRejectFormWidgetState();
}

class _ReasonForRejectFormWidgetState extends State<ReasonForRejectFormWidget> {
  late ReasonForRejectFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReasonForRejectFormModel());
            ...
            builder: (context) => Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  ...
                  _model.changePropertyStatusReject =
                      await LiferayBaseUrlGroup.changePropertyStatusCall.call(
                    propertyId: widget.propertyId,
                    articleId: widget.articleId,
                    status: 0,
                    comments: _model.cRTextFieldController.text,
                    ...
                    await showDialog(
                      ...
                      builder: (dialogContext) {
                        return Dialog(
                          ...
                          child: ReasonForRejectSubmitWidget(
