...
import '/luxary_homes/admin/lease_rqt_db/lease_rqt_db_widget.dart';
...
import 'admin_db_model.dart';
export 'admin_db_model.dart';

class AdminDbWidget extends StatefulWidget {
  const AdminDbWidget({super.key});

  @override
  State<AdminDbWidget> createState() => _AdminDbWidgetState();
}

class _AdminDbWidgetState extends State<AdminDbWidget> {
  late AdminDbModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminDbModel());
                              ...
                              child: Column(
                                ...
                                children: [
                                  if (_model.selectPropertyType ==
                                    ...
                                    Expanded(
                                      child: wrapWithModel(
                                        model: _model.propertyListingDbModel,
                                        updateCallback: () => setState(() {}),
