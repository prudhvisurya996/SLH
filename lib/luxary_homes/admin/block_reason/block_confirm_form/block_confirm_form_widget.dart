...
import 'block_confirm_form_model.dart';
export 'block_confirm_form_model.dart';

class BlockConfirmFormWidget extends StatefulWidget {
  const BlockConfirmFormWidget({
    super.key,
  ...
  @override
  State<BlockConfirmFormWidget> createState() => _BlockConfirmFormWidgetState();
}

class _BlockConfirmFormWidgetState extends State<BlockConfirmFormWidget> {
  late BlockConfirmFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BlockConfirmFormModel());
