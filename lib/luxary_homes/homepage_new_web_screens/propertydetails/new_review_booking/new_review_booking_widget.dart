...
import '/luxary_homes/homepage_new_web_screens/propertydetails/new_review_card/new_review_card_widget.dart';
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                if (FFAppState().propertyBookingDetails.isSharedAllowed == true)
                                                                                  Row(
                                                                                    mainAxisSize: MainAxisSize.min,
                                                                                    children: [
                                                                                      ClipRRect(
                                                                                      ...
                                                                                      Padding(
                                                                                        ...
                                                                                        child: Container(
                                                                                          ...
                                                                                          child: Text(
                                                                                            '${FFAppState().propertyBookingDetails.guestsPerRoom.toString()}${FFAppState().propertyBookingDetails.guestsPerRoom > 1 ? ' GuestsPerRoom' : ' GuestPerRoom'}',
                                                                                            style: GoogleFonts.getFont(
                                                                                              'Work Sans',
                                                                                              color: FlutterFlowTheme.of(context).primaryText,
                                                                                              fontWeight: FontWeight.w500,
                                                                                ...
                                                                                if (FFAppState().propertyBookingDetails.isSharedAllowed == false)
                                                                                  Padding(
                                                                                    ...
                                                                                    child: Row(
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        Text(
                                                                                          '${FFAppState().propertyBookingDetails.noOfGuests.toString()}${FFAppState().propertyBookingDetails.noOfGuests > 1 ? ' Guests' : ' Guest'}',
                                                                                          style: GoogleFonts.getFont(
                                                                                            'Work Sans',
                                                                                            color: FlutterFlowTheme.of(context).primaryText,
                                                                                            fontWeight: FontWeight.w500,
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Padding(
                                                                                        ...
                                                                                        child: Container(
                                                                                          ...
                                                                                          child: Text(
                                                                                            'INR. ${FFAppState().propertyBookingDetails.roomPricePerNight.toString()} PricePerRoom',
                                                                                            style: GoogleFonts.getFont(
                                                                                              'Work Sans',
                                                                                              color: FlutterFlowTheme.of(context).primaryText,
                                                                                              fontWeight: FontWeight.w500,
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Container(
                                                                                        ...
                                                                                        child: Text(
                                                                                          '${FFAppState().propertyBookingDetails.sharedWashrooms.toString()}${FFAppState().propertyBookingDetails.sharedWashrooms > 1 ? ' SharedBathrooms' : ' SharedBathroom'}',
                                                                                          style: GoogleFonts.getFont(
                                                                                            'Work Sans',
                                                                                            color: FlutterFlowTheme.of(context).primaryText,
                                                                                            fontWeight: FontWeight.w500,
