...
import 'new_modify_booking_model.dart';
export 'new_modify_booking_model.dart';

class NewModifyBookingWidget extends StatefulWidget {
  const NewModifyBookingWidget({super.key});

  @override
  State<NewModifyBookingWidget> createState() => _NewModifyBookingWidgetState();
}

class _NewModifyBookingWidgetState extends State<NewModifyBookingWidget> {
  late NewModifyBookingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewModifyBookingModel());
