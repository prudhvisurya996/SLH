...
import 'new_property_details_comp_widget.dart'
    show NewPropertyDetailsCompWidget;
...
class NewPropertyDetailsCompModel
    extends FlutterFlowModel<NewPropertyDetailsCompWidget> {
  ///  Local state fields for this component.

  int? propertyId;

  List<DateTime> selectedFromDates = [];
  void addToSelectedFromDates(DateTime item) => selectedFromDates.add(item);
  void removeFromSelectedFromDates(DateTime item) =>
      selectedFromDates.remove(item);
  void removeAtIndexFromSelectedFromDates(int index) =>
      selectedFromDates.removeAt(index);
  void insertAtIndexInSelectedFromDates(int index, DateTime item) =>
      selectedFromDates.insert(index, item);
  void updateSelectedFromDatesAtIndex(int index, Function(DateTime) updateFn) =>
      selectedFromDates[index] = updateFn(selectedFromDates[index]);
