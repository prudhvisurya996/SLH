...
import 'dart:async';
import 'new_property_details_nav_copy_widget.dart'
    show NewPropertyDetailsNavCopyWidget;
...
class NewPropertyDetailsNavCopyModel
    extends FlutterFlowModel<NewPropertyDetailsNavCopyWidget> {
  ...
  // Model for new_property_details_comp component.
  late NewPropertyDetailsCompModel newPropertyDetailsCompModel;
  ...
  void initState(BuildContext context) {
    ...
    newPropertyDetailsCompModel =
        createModel(context, () => NewPropertyDetailsCompModel());
  ...
  void dispose() {
    ...
    newPropertyDetailsCompModel.dispose();
