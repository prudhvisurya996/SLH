...
import 'w_ex_hosting_form_model.dart';
export 'w_ex_hosting_form_model.dart';

class WExHostingFormWidget extends StatefulWidget {
  const WExHostingFormWidget({super.key});

  @override
  State<WExHostingFormWidget> createState() => _WExHostingFormWidgetState();
}

class _WExHostingFormWidgetState extends State<WExHostingFormWidget> {
  late WExHostingFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WExHostingFormModel());
                                                                  ...
                                                                  if (GetDataFromPinCodeCall
                                                                      ...
                                                                      _model
                                                                        ...
                                                                        (_model.pincodeResponseWeb?.jsonBody ??
                                                                            ...
                                                                            (_model.pincodeResponseWeb?.jsonBody ??
                                                                              ...
                                                                              .length -
                                                                          1]);
                                                                      _model.countryTextController?.selection = TextSelection.collapsed(
                                                                          offset: _model
                                                                              .countryTextController!
                                                                              .text
                                                                              .length);
                                                                      ...
                                                                      _model
                                                                        ...
                                                                        (_model.pincodeResponseWeb?.jsonBody ??
                                                                            ...
                                                                            (_model.pincodeResponseWeb?.jsonBody ??
                                                                              ...
                                                                              .length -
                                                                          2]);
                                                                      _model.stateTextController?.selection = TextSelection.collapsed(
                                                                          offset: _model
                                                                              .stateTextController!
                                                                              .text
                                                                              .length);
                                                                      ...
                                                                      _model
                                                                        ...
                                                                        (_model.pincodeResponseWeb?.jsonBody ??
                                                                            ...
                                                                            (_model.pincodeResponseWeb?.jsonBody ??
                                                                              ...
                                                                              .length -
                                                                          3]);
                                                                      _model.cityTextController?.selection = TextSelection.collapsed(
                                                                          offset: _model
                                                                              .cityTextController!
                                                                              .text
                                                                              .length);
                                                                    ...
                                                                    setState(
                                                                      ...
                                                                      _model
                                                                          ...
                                                                          : '');
                                                                      _model.localityFieldTextController?.selection = TextSelection.collapsed(
                                                                          offset: _model
                                                                              .localityFieldTextController!
                                                                              .text
                                                                              .length);
                            ...
                            while (_model.index <
                              ...
                              if (_model.index <
                                ...
                                if (FFAppState()
                                  ...
                                  if (functions.isFileSize(_model
                                      .uploadedLocalFiles[_model.index])!) {
