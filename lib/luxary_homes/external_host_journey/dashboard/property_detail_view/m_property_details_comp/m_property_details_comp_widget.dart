...
import 'm_property_details_comp_model.dart';
export 'm_property_details_comp_model.dart';

class MPropertyDetailsCompWidget extends StatefulWidget {
  const MPropertyDetailsCompWidget({
    super.key,
  ...
  @override
  State<MPropertyDetailsCompWidget> createState() =>
      _MPropertyDetailsCompWidgetState();
}

class _MPropertyDetailsCompWidgetState
    extends State<MPropertyDetailsCompWidget> {
  late MPropertyDetailsCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MPropertyDetailsCompModel());
