...
import 'm_ongoing_property_listing_model.dart';
export 'm_ongoing_property_listing_model.dart';

class MOngoingPropertyListingWidget extends StatefulWidget {
  const MOngoingPropertyListingWidget({
    super.key,
  ...
  @override
  State<MOngoingPropertyListingWidget> createState() =>
      _MOngoingPropertyListingWidgetState();
}

class _MOngoingPropertyListingWidgetState
    extends State<MOngoingPropertyListingWidget> {
  late MOngoingPropertyListingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MOngoingPropertyListingModel());
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, ongoingPropertyListingIndex) {
                            final ongoingPropertyListingItem =
                                ongoingPropertyListing[
                                    ongoingPropertyListingIndex];
                            return Padding(
