...
import 'm_rejected_property_listing_model.dart';
export 'm_rejected_property_listing_model.dart';

class MRejectedPropertyListingWidget extends StatefulWidget {
  const MRejectedPropertyListingWidget({
    super.key,
  ...
  @override
  State<MRejectedPropertyListingWidget> createState() =>
      _MRejectedPropertyListingWidgetState();
}

class _MRejectedPropertyListingWidgetState
    extends State<MRejectedPropertyListingWidget> {
  late MRejectedPropertyListingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MRejectedPropertyListingModel());
                        ...
                        itemBuilder: (context, rejectedPropertyListingIndex) {
                          ...
                          return InkWell(
                            ...
                            onTap: () async {
                              ...
                              context.pushNamed('Exhost_detail_View');
                            },
                            child: Card(
