...
import 'ex_rjtd_ppts_model.dart';
export 'ex_rjtd_ppts_model.dart';

class ExRjtdPptsWidget extends StatefulWidget {
  const ExRjtdPptsWidget({
    super.key,
  ...
  @override
  State<ExRjtdPptsWidget> createState() => _ExRjtdPptsWidgetState();
}

class _ExRjtdPptsWidgetState extends State<ExRjtdPptsWidget> {
  late ExRjtdPptsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExRjtdPptsModel());
