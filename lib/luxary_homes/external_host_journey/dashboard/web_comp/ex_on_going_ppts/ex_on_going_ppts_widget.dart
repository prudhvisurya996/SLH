...
import 'ex_on_going_ppts_model.dart';
export 'ex_on_going_ppts_model.dart';

class ExOnGoingPptsWidget extends StatefulWidget {
  const ExOnGoingPptsWidget({
    super.key,
  ...
  @override
  State<ExOnGoingPptsWidget> createState() => _ExOnGoingPptsWidgetState();
}

class _ExOnGoingPptsWidgetState extends State<ExOnGoingPptsWidget> {
  late ExOnGoingPptsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExOnGoingPptsModel());
