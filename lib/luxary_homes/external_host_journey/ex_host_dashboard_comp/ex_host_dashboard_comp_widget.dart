...
import 'ex_host_dashboard_comp_model.dart';
export 'ex_host_dashboard_comp_model.dart';

class ExHostDashboardCompWidget extends StatefulWidget {
  const ExHostDashboardCompWidget({super.key});

  @override
  State<ExHostDashboardCompWidget> createState() =>
      _ExHostDashboardCompWidgetState();
}

class _ExHostDashboardCompWidgetState extends State<ExHostDashboardCompWidget> {
  late ExHostDashboardCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExHostDashboardCompModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      if (_model.propertyStatus == 0)
                        Flexible(
                          child: wrapWithModel(
                            model: _model.exHostOngoingModel,
                            updateCallback: () => setState(() {}),
                            child: ExHostOngoingWidget(
                      ...
                      if (_model.propertyStatus == 3)
                        Expanded(
                          child: wrapWithModel(
                            model: _model.exHostRejectedModel,
                            updateCallback: () => setState(() {}),
                            child: ExHostRejectedWidget(
                              propertyStatus: _model.propertyStatus!,
                              pageNo: _model.pageNo!,
                              pageSize: _model.pageSize!,
                              userId: FFAppState().userData.userId,
                      ...
                      if (_model.propertyStatus == 4)
                        Flexible(
                          child: wrapWithModel(
                            model: _model.exHostListedModel,
                            updateCallback: () => setState(() {}),
                            child: ExHostListedWidget(
                              propertyStatus: _model.propertyStatus!,
                              pageNo: _model.pageNo!,
                              pageSize: _model.pageSize!,
                              userId: FFAppState().userData.userId,
