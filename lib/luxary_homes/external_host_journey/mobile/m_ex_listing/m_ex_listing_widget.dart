...
import 'm_ex_listing_model.dart';
export 'm_ex_listing_model.dart';

class MExListingWidget extends StatefulWidget {
  const MExListingWidget({
    super.key,
  ...
  @override
  State<MExListingWidget> createState() => _MExListingWidgetState();
}

class _MExListingWidgetState extends State<MExListingWidget> {
  late MExListingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MExListingModel());
        ...
        builder: (context, snapshot) {
          ...
          return Builder(
            builder: (context) {
              ...
              if (listedPropertyListing.isEmpty) {
                return Center(
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, listedPropertyListingIndex) {
                  final listedPropertyListingItem =
                      listedPropertyListing[listedPropertyListingIndex];
                  return Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        FFAppState().ExHostDetailView = ExHostDetailViewStruct(
                          status: widget.propertyStatus,
                          articleId:
                              int.parse(listedPropertyListingIndex.toString()),
                        );
                        setState(() {});
