...
import 'm_ex_hosting_model.dart';
export 'm_ex_hosting_model.dart';

class MExHostingWidget extends StatefulWidget {
  const MExHostingWidget({super.key});

  @override
  State<MExHostingWidget> createState() => _MExHostingWidgetState();
}

class _MExHostingWidgetState extends State<MExHostingWidget> {
  late MExHostingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MExHostingModel());
          ...
          child: Visibility(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(12.0, 10.0, 0.0, 12.0),
                  child: Row(
                          ...
                          if (_model.uploadPictures.length < 2) {
                            ...
                            if (_model.uploadPictures.length < 6) {
                              FFAppState().ExternalHostJourney =
                                ...
                                streetAddress: _model.streetTextController.text,
