...
import 'submit_confirm_form_model.dart';
export 'submit_confirm_form_model.dart';

class SubmitConfirmFormWidget extends StatefulWidget {
  const SubmitConfirmFormWidget({super.key});

  @override
  State<SubmitConfirmFormWidget> createState() =>
      _SubmitConfirmFormWidgetState();
}

class _SubmitConfirmFormWidgetState extends State<SubmitConfirmFormWidget> {
  late SubmitConfirmFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubmitConfirmFormModel());
