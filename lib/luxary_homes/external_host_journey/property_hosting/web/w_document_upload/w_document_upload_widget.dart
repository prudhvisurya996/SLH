...
import 'w_document_upload_model.dart';
export 'w_document_upload_model.dart';

class WDocumentUploadWidget extends StatefulWidget {
  const WDocumentUploadWidget({super.key});

  @override
  State<WDocumentUploadWidget> createState() => _WDocumentUploadWidgetState();
}

class _WDocumentUploadWidgetState extends State<WDocumentUploadWidget> {
  late WDocumentUploadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WDocumentUploadModel());
