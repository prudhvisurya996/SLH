...
import 'm_document_uploadpage_model.dart';
export 'm_document_uploadpage_model.dart';

class MDocumentUploadpageWidget extends StatefulWidget {
  const MDocumentUploadpageWidget({
    super.key,
  ...
  @override
  State<MDocumentUploadpageWidget> createState() =>
      _MDocumentUploadpageWidgetState();
}

class _MDocumentUploadpageWidgetState extends State<MDocumentUploadpageWidget> {
  late MDocumentUploadpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MDocumentUploadpageModel());
                                                ...
                                                await showDialog(
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      title: Text('Invalid'),
                                                      content: Text(
                                                          'Make sure the file is smaller than 5mb and the file name is shorter than 50 characters.'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
                              ...
                              onPressed: () async {
                                ...
                                if ((_model.govtIdName != null &&
                                  ...
                                  if (FFAppState().exHostAcceptTC == true) {
                                    ...
                                    _shouldSetState = true;
                                    if ((_model.refreshTokenExHostProperty
                                            ?.succeeded ??
                                        true)) {
                                      setState(() {
                                      ...
                                      _shouldSetState = true;
                                      if ((_model
                                              .exHostPropertyResp?.succeeded ??
                                          true)) {
                                        _model.exHostSecondAPI =
                                            await LiferayBaseUrlGroup
                                                .exHostPropertySecondHalfCall
                                                .call(
                                          accessToken: FFAppState().accessToken,
                                          filesArrayJson:
                                              functions.getDocfileKeyValue(
                                                  _model.govtID,
                                                  'govId',
                                                  _model.propertID,
                                                  'propDoc'),
