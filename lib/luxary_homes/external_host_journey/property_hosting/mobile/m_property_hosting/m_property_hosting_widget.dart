...
import 'm_property_hosting_model.dart';
export 'm_property_hosting_model.dart';

class MPropertyHostingWidget extends StatefulWidget {
  const MPropertyHostingWidget({super.key});

  @override
  State<MPropertyHostingWidget> createState() => _MPropertyHostingWidgetState();
}

class _MPropertyHostingWidgetState extends State<MPropertyHostingWidget> {
  late MPropertyHostingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MPropertyHostingModel());

    _model.propertyTitleTextController ??= TextEditingController();
    _model.propertyTitleFocusNode ??= FocusNode();

    _model.propertPricingTextController ??= TextEditingController();
    _model.propertPricingFocusNode ??= FocusNode();
    ...
    _model.flatTextController ??= TextEditingController();
          ...
          child: Visibility(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(12.0, 16.0, 12.0, 12.0),
                  child: Row(
                            ...
                            children: [
                                    ...
                                    return Builder(
                                      builder: (context) {
                                        final propertySubType =
                                            rowExHostSubPropertyTypesResponse
                                                .jsonBody
                                                .toList();
                                        return SingleChildScrollView(
                                          scrollDirection: Axis.horizontal,
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .propertPricingTextController,
                                                focusNode: _model
                                                    .propertPricingFocusNode,
                                                autofocus: false,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  enabledBorder:
                                  ...
                                  child: RichText(
                                    ...
                                    text: TextSpan(
                                      children: [
                                        TextSpan(
                                          text:
                                              'Do you have existing Amenities?',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Open Sans',
                                  ...
                                  child: Padding(
                                    ...
                                    child: FutureBuilder<ApiCallResponse>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        final columnGetAmenitiesResponse =
                                            snapshot.data!;
                                        return Column(
                                          mainAxisSize: MainAxisSize.max,
                                          crossAxisAlignment:
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  if ((_model.pincodeResponseMobile != null) &&
                                      (GetDataFromPinCodeCall
                                                  .postalCodeLocalities(
                                                (_model.pincodeResponseMobile
                                                        ?.jsonBody ??
                                    ...
                                    Padding(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        onChanged: (val) => setState(() =>
                                            _model.localityDropdownValue = val),
                                        height: 50.0,
                                        maxHeight:
                                            MediaQuery.sizeOf(context).height *
                                                0.4,
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        ...
                                        return Wrap(
                                          ...
                                          clipBehavior: Clip.none,
                                          children:
                                              List.generate(uploadImgs.length,
                                                  (uploadImgsIndex) {
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          setState(() {
                                                            _model.removeFromUploadPictures(
                                                                uploadImgsItem);
                                                          });
                                                        },
                                                        child: Text(
                                      ...
                                      while (_model.index! <
                                        ...
                                        if (_model.index! <
                                          ...
                                          if (FFAppState()
                                              ...
                                              .contains(
                                                  functions.getFileExtensions(
                                                      _model.uploadedLocalFiles[
                                                          _model.index!]))) {
                                            setState(() {
                                              _model.addToUploadPictures(
                                                  _model.uploadedLocalFiles[
                                                      _model.index!]);
                                            });
                                          } else {
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        if ((GetDataFromPinCodeCall.postalCodeLocalities(
                                      (_model.pincodeResponseMobile?.jsonBody ??
                                          ''),
                                    ) !=
                                    null &&
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('Info'),
                                content: Text('Select locality from dropdown.'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                          ...
                          return;
                                ...
                                (GetDataFromPinCodeCall.postalCodeLocalities(
                                  (_model.pincodeResponseMobile?.jsonBody ??
                                    ...
                                    .isNotEmpty) &&
                            (_model.localityFieldTextController.text == null ||
                          ...
                          if (_model.uploadPictures.length < 2) {
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                            ...
                            if (_model.uploadPictures.length < 6) {
                              setState(() {
                                FFAppState().ExternalHostJourney =
                                    ExHostJourneyStruct(
                                  propertyTitle:
                                  ...
                                  flatNo: _model.flatTextController.text,
                                  streetAddress:
                                  ...
                                  pricepermonth: functions.toDouble(
                                      _model.propertPricingTextController.text),
                                );
                              });

                              context.pushNamed(
                                'm_documentUploadpage',
                                queryParameters: {
                                  'fileNames': serializeParam(
                                  ...
                                  'propertyDetails': serializeParam(
                                    functions.collectExHostPropertyDetails(
                                        FFAppState()
                                            .ExternalHostJourney
                                            .propertyTitle,
                                        FFAppState()
                                        ...
                                        FFAppState()
                                            .ExternalHostJourney
                                            .country,
                                        FFAppState().ExternalHostJourney.flatNo,
                                        FFAppState()
                                            .ExternalHostJourney
                                            .streetAddress,
                                        FFAppState()
                                        ...
                                        FFAppState()
                                            .ExternalHostJourney
                                            .locality,
                                        FFAppState().ExternalHostJourney.city,
                                        FFAppState().ExternalHostJourney.state,
                                        FFAppState()
                                            .ExternalHostJourney
                                            .pincode,
                                        FFAppState()
                                        ...
                                        FFAppState().ExHostSelctedAM.toList(),
                                        getJsonField(
