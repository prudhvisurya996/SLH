...
import 'exhost_t_c_component_model.dart';
export 'exhost_t_c_component_model.dart';

class ExhostTCComponentWidget extends StatefulWidget {
  const ExhostTCComponentWidget({super.key});

  @override
  State<ExhostTCComponentWidget> createState() =>
      _ExhostTCComponentWidgetState();
}

class _ExhostTCComponentWidgetState extends State<ExhostTCComponentWidget> {
  late ExhostTCComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExhostTCComponentModel());
