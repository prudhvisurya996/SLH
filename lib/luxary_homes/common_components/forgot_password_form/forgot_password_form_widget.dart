...
import 'forgot_password_form_model.dart';
export 'forgot_password_form_model.dart';
...
class _ForgotPasswordFormWidgetState extends State<ForgotPasswordFormWidget> {
  late ForgotPasswordFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ForgotPasswordFormModel());
