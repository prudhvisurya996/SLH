...
export 'register_form_model.dart';
...
class _RegisterFormWidgetState extends State<RegisterFormWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisterFormModel());
                        ...
                        onChanged: (_) => EasyDebounce.debounce(
                          ...
                          () async {
                            ...
                            setState(() {
                              ...
                              _model.localityFieldTextController?.clear();
                              _model.streetFieldTextController?.clear();
                            });
                                ...
                                _model.countryFieldTextController
                                  ...
                                  (_model.pincodeResponseSignUp?.jsonBody ??
                                      ...
                                      (_model.pincodeResponseSignUp?.jsonBody ??
                                        ...
                                        .length -
                                    1]);
                                _model.countryFieldTextController?.selection =
                                ...
                                _model.stateFieldTextController
                                  ...
                                  (_model.pincodeResponseSignUp?.jsonBody ??
                                      ...
                                      (_model.pincodeResponseSignUp?.jsonBody ??
                                        ...
                                        .length -
                                    2]);
                                _model.stateFieldTextController?.selection =
                                    TextSelection.collapsed(
                                        offset: _model.stateFieldTextController!
                                            .text.length);
                              });
                              setState(() {
                                _model.cityTownFieldTextController
                                  ...
                                  (_model.pincodeResponseSignUp?.jsonBody ??
                                      ...
                                      (_model.pincodeResponseSignUp?.jsonBody ??
                                        ...
                                        .length -
                                    3]);
                                _model.cityTownFieldTextController?.selection =
                                    TextSelection.collapsed(
                                        offset: _model
                                            .cityTownFieldTextController!
                                            .text
                                            .length);
                              });
                              setState(() {
                                _model.localityFieldTextController?.text =
                                    (GetDataFromPinCodeCall.longNames(
                                        ...
                                        ? (GetDataFromPinCodeCall.longNames(
                                            ...
                                            4])
                                        : '');
                                _model.localityFieldTextController?.selection =
                                    TextSelection.collapsed(
                                        offset: _model
