...
import '/luxary_homes/common_components/architect_team/at_reject/at_reject_widget.dart';
import '/luxary_homes/common_components/architect_team/m_at_accept_confirm/m_at_accept_confirm_widget.dart';
...
import 'at_detail_view_model.dart';
export 'at_detail_view_model.dart';

class AtDetailViewWidget extends StatefulWidget {
  const AtDetailViewWidget({super.key});

  @override
  State<AtDetailViewWidget> createState() => _AtDetailViewWidgetState();
}

class _AtDetailViewWidgetState extends State<AtDetailViewWidget>
    with TickerProviderStateMixin {
  late AtDetailViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AtDetailViewModel());
                      ...
                      Flexible(
                        child: FutureBuilder<ApiCallResponse>(
                          future: MicroserviceExternalHostGroup
                              ...
                              .call(
                            reviewId: FFAppState().atDetailView.reviewId,
                          ),
                      ...
                      return Column(
                        ...
                        children: [
                            ...
                            child: Padding(
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    if (FFAppState().atDetailView.status == 4)
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 16.0, 10.0, 0.0),
                                        child: Row(
                                    ...
                                    Stack(
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          alignment:
                                              AlignmentDirectional(0.82, 0.08),
                                          child: Builder(
                          ...
                          Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              if (FFAppState().atDetailView.status == 0)
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 14.0),
                                  child: Row(
                              ...
                              if (FFAppState().atDetailView.status == 1)
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 14.0),
                                  child: Row(
                                      ...
                                      Builder(
                                        builder: (context) => FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            _model.refreshRespForATStartedMobile =
                                            ...
                                            if ((_model
                                              ...
                                              setState(() {});
                                              _model.atStatusUpdateRespStartedMobile =
                                                  await LiferayBaseUrlGroup
                                                      .aTStatusUpdateCall
                                                      .call(
                                                accessToken:
                                              ...
                                              _shouldSetState = true;
                                              if ((_model
                                                      .atStatusUpdateRespStartedMobile
                                                      ?.succeeded ??
                                                  true)) {
