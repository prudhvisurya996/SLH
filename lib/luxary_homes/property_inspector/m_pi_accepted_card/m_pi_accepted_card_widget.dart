...
import 'm_pi_accepted_card_model.dart';
export 'm_pi_accepted_card_model.dart';

class MPiAcceptedCardWidget extends StatefulWidget {
  const MPiAcceptedCardWidget({
    super.key,
    required this.title,
  ...
  @override
  State<MPiAcceptedCardWidget> createState() => _MPiAcceptedCardWidgetState();
}

class _MPiAcceptedCardWidgetState extends State<MPiAcceptedCardWidget> {
  late MPiAcceptedCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MPiAcceptedCardModel());
