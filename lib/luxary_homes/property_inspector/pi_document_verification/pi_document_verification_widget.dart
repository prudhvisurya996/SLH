...
import 'pi_document_verification_model.dart';
export 'pi_document_verification_model.dart';

class PiDocumentVerificationWidget extends StatefulWidget {
  const PiDocumentVerificationWidget({
    super.key,
  ...
  @override
  State<PiDocumentVerificationWidget> createState() =>
      _PiDocumentVerificationWidgetState();
}

class _PiDocumentVerificationWidgetState
    extends State<PiDocumentVerificationWidget> {
  late PiDocumentVerificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PiDocumentVerificationModel());
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            if (!((_model.personaldocumentsverifiedValue !=
                                            null &&
                                        _model.personaldocumentsverifiedValue !=
                                            '') &&
                                    (_model.propertydocumentsverifiedValue !=
                                            null &&
                                        _model.propertydocumentsverifiedValue !=
                                            '') &&
                            ...
                            if ((_model.personaldocumentsverifiedValue != null && _model.personaldocumentsverifiedValue != '') &&
                                (_model.propertydocumentsverifiedValue !=
                                        null &&
                                    _model.propertydocumentsverifiedValue !=
                                        '') &&
                      ...
                      Row(
                        ...
                        children: [
                          if (!((_model.personaldocumentsverifiedValue !=
                            ...
                            CircularPercentIndicator(
                              percent: (_model.personaldocumentsverifiedValue !=
                                              null &&
                                          _model.personaldocumentsverifiedValue !=
                                              '') ||
                                      (_model.propertydocumentsverifiedValue !=
                          ...
                          if ((_model.personaldocumentsverifiedValue != null && _model.personaldocumentsverifiedValue != '') &&
                              (_model.propertydocumentsverifiedValue != null &&
                                  _model.propertydocumentsverifiedValue !=
                                      '') &&
                              (_model.uploadedLocalFile2 != null &&
                                  (_model.uploadedLocalFile2.bytes
