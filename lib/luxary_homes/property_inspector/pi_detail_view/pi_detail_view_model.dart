...
import 'pi_detail_view_widget.dart' show PiDetailViewWidget;
...
class PiDetailViewModel extends FlutterFlowModel<PiDetailViewWidget> {
  ...
  // Stores action output result for [Backend Call - API (Refresh Token API)] action in Button widget.
  ApiCallResponse? refreshRespForPIStartedMobile;
  // Stores action output result for [Backend Call - API (PI Status Update)] action in Button widget.
  ApiCallResponse? piStatusUpdateRespStartedMobile;
