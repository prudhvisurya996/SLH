...
import '/luxary_homes/property_inspector/accepted_tasks/accepted_tasks_widget.dart';
import '/luxary_homes/property_inspector/assigned_tasks/assigned_tasks_widget.dart';
import '/luxary_homes/property_inspector/completed_tasks/completed_tasks_widget.dart';
import '/luxary_homes/property_inspector/rejected_task/rejected_task_widget.dart';
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Opacity(
                    opacity: _model.status == 1 ? 1.0 : 0.8,
                    child: Padding(
                      padding:
                  ...
                  Opacity(
                    opacity: _model.status == 2 ? 1.0 : 0.8,
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 25.0, 0.0),
                      child: InkWell(
                  ...
                  Opacity(
                    opacity: _model.status == 4 ? 1.0 : 0.8,
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 25.0, 0.0),
                      child: InkWell(
                ...
                child: Column(
                  ...
                  children: [
                    if (_model.status == 0)
                      Flexible(
                        child: wrapWithModel(
                          model: _model.assignedTasksModel,
                          updateCallback: () => setState(() {}),
                          child: AssignedTasksWidget(
                            status: _model.status!,
                            pageNo: _model.pageNo!,
                            pageSize: _model.pageSize!,
                    ...
                    if (_model.status == 1)
                      Expanded(
                        child: wrapWithModel(
                          model: _model.acceptedTasksModel,
                          updateCallback: () => setState(() {}),
                          child: AcceptedTasksWidget(
                            status: _model.status!,
                            pageNo: _model.pageNo!,
                            pageSize: _model.pageSize!,
                            totalCount: MicroserviceExternalHostGroup
                    ...
                    if (_model.status == 3)
                      Flexible(
                        child: wrapWithModel(
                          model: _model.completedTasksModel,
                          updateCallback: () => setState(() {}),
                    ...
                    if (_model.status == 4)
                      Expanded(
                        child: wrapWithModel(
                          model: _model.rejectedTaskModel,
                          updateCallback: () => setState(() {}),
                          child: RejectedTaskWidget(
                            status: _model.status!,
                            pageNo: _model.pageNo!,
                            pageSize: _model.pageSize!,
                            totalCount: MicroserviceExternalHostGroup
                          ...
                          children: [
                            ...
                            TextSpan(
                              text: valueOrDefault<String>(
                                MicroserviceExternalHostGroup.pIDashboardCall
                                    .currentPage(
                                      columnPIDashboardResponse.jsonBody,
                                    )
                                    ?.toString(),
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              if (_model.pageNo! <
                                ...
                                setState(() {
                                  _model.pageNo = MicroserviceExternalHostGroup
                                      .pIDashboardCall
                                      .lastPage(
                                    columnPIDashboardResponse.jsonBody,
                                  );
