...
import 'pi_reject_form_model.dart';
export 'pi_reject_form_model.dart';

class PiRejectFormWidget extends StatefulWidget {
  const PiRejectFormWidget({
    super.key,
  ...
  @override
  State<PiRejectFormWidget> createState() => _PiRejectFormWidgetState();
}

class _PiRejectFormWidgetState extends State<PiRejectFormWidget> {
  late PiRejectFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PiRejectFormModel());
                ...
                Builder(
                  builder: (context) => FFButtonWidget(
                    onPressed: () async {
                      ...
                      _model.refreshRespForATUpdateStatus =
                      ...
                      if ((_model.refreshRespForATUpdateStatus?.succeeded ??
                          true)) {
                        FFAppState().accessToken = getJsonField(
                          (_model.refreshRespForATUpdateStatus?.jsonBody ?? ''),
                          r'''$.access_token''',
                        ).toString();
                        ...
                        setState(() {});
                        _model.atStatusUpdateRespReject =
                        ...
                        _shouldSetState = true;
                        if ((_model.atStatusUpdateRespReject?.succeeded ??
                            true)) {
                              ...
                              builder: (dialogContext) {
                                return Dialog(
                                  ...
                                  child: Container(
                                    ...
                                    child: AtPropertyRejectedWidget(
