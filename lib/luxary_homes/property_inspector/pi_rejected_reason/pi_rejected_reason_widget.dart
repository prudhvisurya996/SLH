...
import 'pi_rejected_reason_model.dart';
export 'pi_rejected_reason_model.dart';

class PiRejectedReasonWidget extends StatefulWidget {
  const PiRejectedReasonWidget({super.key});

  @override
  State<PiRejectedReasonWidget> createState() => _PiRejectedReasonWidgetState();
}

class _PiRejectedReasonWidgetState extends State<PiRejectedReasonWidget> {
  late PiRejectedReasonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PiRejectedReasonModel());
