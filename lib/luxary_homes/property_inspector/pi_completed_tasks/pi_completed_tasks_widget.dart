...
import 'pi_completed_tasks_model.dart';
export 'pi_completed_tasks_model.dart';

class PiCompletedTasksWidget extends StatefulWidget {
  const PiCompletedTasksWidget({
    super.key,
  ...
  @override
  State<PiCompletedTasksWidget> createState() => _PiCompletedTasksWidgetState();
}

class _PiCompletedTasksWidgetState extends State<PiCompletedTasksWidget> {
  late PiCompletedTasksModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PiCompletedTasksModel());
