...
class PropertyDetailsModel extends FlutterFlowModel<PropertyDetailsWidget> {
  ...
  // Model for property_details_comp component.
  late PropertyDetailsCompModel propertyDetailsCompModel;
  ...
  void initState(BuildContext context) {
    ...
    propertyDetailsCompModel =
        createModel(context, () => PropertyDetailsCompModel());
  ...
  void dispose() {
    ...
    propertyDetailsCompModel.dispose();
