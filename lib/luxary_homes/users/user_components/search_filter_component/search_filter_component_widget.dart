...
import '/luxary_homes/users/user_components/filter_components/filter_properties_main_component/filter_properties_main_component_widget.dart';
import '/luxary_homes/users/user_components/search_components/search_component/search_component_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';
import 'search_filter_component_model.dart';
export 'search_filter_component_model.dart';

class SearchFilterComponentWidget extends StatefulWidget {
  const SearchFilterComponentWidget({super.key});

  @override
  State<SearchFilterComponentWidget> createState() =>
      _SearchFilterComponentWidgetState();
}

class _SearchFilterComponentWidgetState
    extends State<SearchFilterComponentWidget> {
  late SearchFilterComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchFilterComponentModel());
                  ...
                  if (MediaQuery.sizeOf(context).width < 991.0) {
                    await showModalBottomSheet(
                      ...
                      builder: (context) {
                        return Padding(
                          padding: MediaQuery.viewInsetsOf(context),
                          child: FilterPropertiesMainComponentWidget(),
                        );
                      },
                    ).then((value) => safeSetState(() {}));
                  } else {
