...
import 'search_form_component_model.dart';
export 'search_form_component_model.dart';

class SearchFormComponentWidget extends StatefulWidget {
  const SearchFormComponentWidget({super.key});

  @override
  State<SearchFormComponentWidget> createState() =>
      _SearchFormComponentWidgetState();
}

class _SearchFormComponentWidgetState extends State<SearchFormComponentWidget> {
  late SearchFormComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchFormComponentModel());
