...
import 'confirm_manage_booking_form_w_model.dart';
export 'confirm_manage_booking_form_w_model.dart';

class ConfirmManageBookingFormWWidget extends StatefulWidget {
  const ConfirmManageBookingFormWWidget({super.key});

  @override
  State<ConfirmManageBookingFormWWidget> createState() =>
      _ConfirmManageBookingFormWWidgetState();
}

class _ConfirmManageBookingFormWWidgetState
    extends State<ConfirmManageBookingFormWWidget> {
  late ConfirmManageBookingFormWModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmManageBookingFormWModel());
