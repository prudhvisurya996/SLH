...
import 'feed_back_form_component_model.dart';
export 'feed_back_form_component_model.dart';

class FeedBackFormComponentWidget extends StatefulWidget {
  const FeedBackFormComponentWidget({
    super.key,
  ...
  @override
  State<FeedBackFormComponentWidget> createState() =>
      _FeedBackFormComponentWidgetState();
}

class _FeedBackFormComponentWidgetState
    extends State<FeedBackFormComponentWidget> {
  late FeedBackFormComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeedBackFormComponentModel());
                ...
                onPressed: () async {
                  ...
                  if (_model.ratingBarValue! > 0.0) {
                    ...
                    _model.submitRatingReviewResponse =
                        await LiferayBaseUrlGroup.ratingReviewCall.call(
                        ...
                        await showModalBottomSheet(
                          ...
                          builder: (context) {
                            return Padding(
                              ...
                              child: FeedBackSubmitCompWidget(
                                articleId: widget.articleId!,
                              ),
                            );
                          },
