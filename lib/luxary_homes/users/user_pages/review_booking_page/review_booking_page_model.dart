...
import 'review_booking_page_widget.dart' show ReviewBookingPageWidget;
...
class ReviewBookingPageModel extends FlutterFlowModel<ReviewBookingPageWidget> {
  ...
  ApiCallResponse? apiResult6p5Copy;
  // Stores action output result for [Backend Call - API (COMPLETE BOOKING)] action in Button widget.
