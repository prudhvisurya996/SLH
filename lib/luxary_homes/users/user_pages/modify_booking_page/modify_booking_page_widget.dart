...
import 'modify_booking_page_model.dart';
export 'modify_booking_page_model.dart';

class ModifyBookingPageWidget extends StatefulWidget {
  const ModifyBookingPageWidget({super.key});

  @override
  State<ModifyBookingPageWidget> createState() =>
      _ModifyBookingPageWidgetState();
}

class _ModifyBookingPageWidgetState extends State<ModifyBookingPageWidget> {
  late ModifyBookingPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModifyBookingPageModel());
                              ...
                              onPressed: () async {
                                setState(() {
                                  FFAppState().updateModifyBookingPageStruct(
                                    (e) => e..guestCount = _model.guestCount,
                                  );
                                });
                                    ...
                                    builder: (context) {
                                      return GestureDetector(
                                        ...
                                        child: Padding(
                                          ...
                                          child: ConfirmManageBookingWidget(),
                                        ),
                                      );
                                    },
