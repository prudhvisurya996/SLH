...
import 'property_details_comp_model.dart';
export 'property_details_comp_model.dart';

class PropertyDetailsCompWidget extends StatefulWidget {
  const PropertyDetailsCompWidget({
    super.key,
  ...
  @override
  State<PropertyDetailsCompWidget> createState() =>
      _PropertyDetailsCompWidgetState();
}

class _PropertyDetailsCompWidgetState extends State<PropertyDetailsCompWidget> {
  late PropertyDetailsCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PropertyDetailsCompModel());
                                                            ...
                                                            Align(
                                                              alignment:
                                                                  AlignmentDirectional(
                                                                      ...
                                                                      -1.0),
                                                              child: Text(
                                                                '${_model.emptyList.length > 0 ? dateTimeFormat('dd MMM yyyy', _model.emptyList.first) : 'Check-In Date'} - ${_model.emptyList.length > 0 ? dateTimeFormat('dd MMM yyyy', _model.emptyList.last) : 'Check-Out Date'}',
                                                                style:
                                                                    GoogleFonts
                                                                        .getFont(
                                                                  'Work Sans',
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child: custom_widgets
                                                                    ...
                                                                    onChangeAction:
                                                                        () async {
                                                                      FFAppState().selectedDateRange = FFAppState()
                                                                          .selectedDateRange
                                                                          .toList()
                                                                          .cast<
                                                                              DateTime>();
                                                          ...
                                                          builderDelegate:
                                                            ...
                                                            itemBuilder: (context,
                                                              ...
                                                              return NewUserReviewsWidget(
                                                                key: Key(
                                                                    'Keyhux_${ratingReviewDataIndex}_of_${_model.gridViewPagingController2!.itemList!.length}'),
                                                                userName:
                                                                    getJsonField(
