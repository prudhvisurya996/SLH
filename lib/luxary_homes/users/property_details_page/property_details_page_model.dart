...
class PropertyDetailsPageModel
  ...
  // Model for DesktopReserveCard component.
  late DesktopReserveCardModel desktopReserveCardModel;
  ...
  void initState(BuildContext context) {
    ...
    desktopReserveCardModel =
        createModel(context, () => DesktopReserveCardModel());
  ...
  void dispose() {
    ...
    desktopReserveCardModel.dispose();
