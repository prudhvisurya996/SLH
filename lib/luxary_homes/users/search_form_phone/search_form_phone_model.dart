...
import 'search_form_phone_widget.dart' show SearchFormPhoneWidget;
...
class SearchFormPhoneModel extends FlutterFlowModel<SearchFormPhoneWidget> {
  ...
  // Stores action output result for [Backend Call - API (SearchCities)] action in search_form_phone widget.
  ApiCallResponse? cityResult;
  // Stores action output result for [Backend Call - API (SearchLocalities)] action in search_form_phone widget.
  ...
  // Stores action output result for [Backend Call - API (Search Filter API)] action in Button widget.
  ApiCallResponse? searchPropertywithDatesOutput;
