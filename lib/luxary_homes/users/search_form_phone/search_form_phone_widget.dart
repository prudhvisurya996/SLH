...
import 'search_form_phone_model.dart';
export 'search_form_phone_model.dart';

class SearchFormPhoneWidget extends StatefulWidget {
  const SearchFormPhoneWidget({super.key});

  @override
  State<SearchFormPhoneWidget> createState() => _SearchFormPhoneWidgetState();
}

class _SearchFormPhoneWidgetState extends State<SearchFormPhoneWidget> {
  late SearchFormPhoneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchFormPhoneModel());
                        ...
                        return TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            contentPadding: EdgeInsetsDirectional.fromSTEB(
                                14.0, 0.0, 14.0, 0.0),
                            suffixIcon: _model.cityTextFieldTextController!.text
                                    .isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                                      _model.cityTextFieldTextController
                            ...
                            if (!(FFAppState().searchDates.isNotEmpty)) {
                              if (functions.whiteSpaces(
                                ...
                                if ((_model.searchPropertyOutput?.succeeded ??
                                  ...
                                  FFAppState().updateSearchPageParametersStruct(
                                    (e) => e
                                      ..index = 0
                                      ..id = getJsonField(
                                        (_model.searchPropertyOutput
