...
import 'search_form_widget.dart' show SearchFormWidget;
...
class SearchFormModel extends FlutterFlowModel<SearchFormWidget> {
  ...
  // Stores action output result for [Backend Call - API (SearchCities)] action in search_form widget.
  ApiCallResponse? cityResult;
  // Stores action output result for [Backend Call - API (SearchLocalities)] action in search_form widget.
