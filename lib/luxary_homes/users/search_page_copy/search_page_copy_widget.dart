                                ...
                                return Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: NewPropertyCardWidget(
                                      key: Key(
                                          'Keynzo_${propertyListingDataIndex}_of_${_model.listViewPagingController1!.itemList!.length}'),
                          ...
                          child: Padding(
                            ...
                            child: FutureBuilder<ApiCallResponse>(
                              future: MicroserviceAvailabilityAPIsGroup
                                  .propertyDetailsCall
                                  .call(
                                propertyId: _model.propertyId != null
                                    ? _model.propertyId
                                    : widget.id,
                              ),
                                                                                ...
                                                                                builderDelegate: PagedChildBuilderDelegate<dynamic>(
                                                                                  ...
                                                                                  itemBuilder: (context, _, ratingReviewDataIndex) {
                                                                                    ...
                                                                                    return NewUserReviewsWidget(
                                                                                      key: Key('Key0in_${ratingReviewDataIndex}_of_${_model.gridViewPagingController2!.itemList!.length}'),
