...
import 'modify_booking_details_page_model.dart';
export 'modify_booking_details_page_model.dart';

class ModifyBookingDetailsPageWidget extends StatefulWidget {
  const ModifyBookingDetailsPageWidget({super.key});

  @override
  State<ModifyBookingDetailsPageWidget> createState() =>
      _ModifyBookingDetailsPageWidgetState();
}

class _ModifyBookingDetailsPageWidgetState
    extends State<ModifyBookingDetailsPageWidget> {
  late ModifyBookingDetailsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModifyBookingDetailsPageModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final modifyBookingDetailsPagePropertyDetailsResponse = snapshot.data!;
                                              ...
                                              child: custom_widgets
                                                ...
                                                imgList: functions
                                                  ...
                                                  MicroserviceAvailabilityAPIsGroup
                                                      .propertyDetailsCall
                                                      .imgesUrls(
                                                    modifyBookingDetailsPagePropertyDetailsResponse
                                                        .jsonBody,
                                                  ),
                                                  'NA',
                                                )),
                                                                    ...
                                                                    valueOrDefault<
                                                                      ...
                                                                      '${valueOrDefault<String>(
                                                                        MicroserviceAvailabilityAPIsGroup
                                                                            .propertyDetailsCall
                                                                            .totalGuests(
                                                                              modifyBookingDetailsPagePropertyDetailsResponse.jsonBody,
                                                                            )
                                                                            ?.toString(),
                                                                        'NA',
                                                                      )}  Guests',
                                              ...
                                              if (responsiveVisibility(
                                                ...
                                                wrapWithModel(
                                                  ...
                                                  updateCallback: () =>
                                                      setState(() {}),
                                                  child:
                                                      ModifyBookingDesktopReserveCardWidget(
