...
import 'search_form_copy_widget.dart' show SearchFormCopyWidget;
...
class SearchFormCopyModel extends FlutterFlowModel<SearchFormCopyWidget> {
  ...
  // Stores action output result for [Backend Call - API (SearchCities)] action in search_formCopy widget.
  ApiCallResponse? cityResult;
  // Stores action output result for [Backend Call - API (SearchLocalities)] action in search_formCopy widget.
