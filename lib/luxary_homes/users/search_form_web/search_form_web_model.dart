...
import 'search_form_web_widget.dart' show SearchFormWebWidget;
...
class SearchFormWebModel extends FlutterFlowModel<SearchFormWebWidget> {
  ...
  // Stores action output result for [Backend Call - API (SearchCities)] action in search_form_web widget.
  ApiCallResponse? cityResult;
  // Stores action output result for [Backend Call - API (SearchLocalities)] action in search_form_web widget.
