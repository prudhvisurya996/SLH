...
import 'search_form_web_model.dart';
export 'search_form_web_model.dart';

class SearchFormWebWidget extends StatefulWidget {
  const SearchFormWebWidget({super.key});

  @override
  State<SearchFormWebWidget> createState() => _SearchFormWebWidgetState();
}

class _SearchFormWebWidgetState extends State<SearchFormWebWidget> {
  late SearchFormWebModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchFormWebModel());
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Autocomplete<String>(
                                    ...
                                    onSelected: (String selection) {
                                      setState(() =>
                                          _model.cityTextFieldSelectedOption =
                                              selection);
                                ...
                                Container(
                                  ...
                                  child: Autocomplete<String>(
                                    ...
                                    onSelected: (String selection) {
                                      setState(() => _model
                                              .localityTextFieldSelectedOption =
                                          selection);
                                      FocusScope.of(context).unfocus();
                                    },
                                    fieldViewBuilder: (
                              ...
                              onPressed: () async {
                                ...
                                if (!(FFAppState().searchDates.isNotEmpty)) {
                                  if (functions.whiteSpaces(
                                    ...
                                    if ((_model
                                            .searchPropertyOutput?.succeeded ??
                                        true)) {
                                      ...
                                      FFAppState().searchPageParameters =
