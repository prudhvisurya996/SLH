...
import 'manage_booking_details_model.dart';
export 'manage_booking_details_model.dart';

class ManageBookingDetailsWidget extends StatefulWidget {
  const ManageBookingDetailsWidget({super.key});

  @override
  State<ManageBookingDetailsWidget> createState() =>
      _ManageBookingDetailsWidgetState();
}

class _ManageBookingDetailsWidgetState
    extends State<ManageBookingDetailsWidget> {
  late ManageBookingDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManageBookingDetailsModel());
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    dateTimeFormat(
                                                                        'dd MMM yyyy',
                                                                        functions.strToDateTimeConversion(MicroserviceBookingAPIsGroup
                                    ...
                                    if ((FFAppState().tripsStatus.completed ==
                                            true) ||
                                                        ...
                                                        child: RichText(
                                                          ...
                                                          text: TextSpan(
                                                            children: [
                                                              ...
                                                              TextSpan(
                                                                text: functions.daysCalculation(functions
                                                                            .fromToDateConversion(
                                                                                getJsonField(
                                                                                  columnViewBookingDetailsResponse.jsonBody,
                                                                                  r'''$.checkInDate''',
                                    ...
                                    if (FFAppState().tripsStatus.cancelled ==
                                        true)
                                      Container(
                                        decoration: BoxDecoration(
                                          color: FlutterFlowTheme.of(context)
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      if (((FFAppState().ManageBookingDetails.modifiable == true) &&
                                                                              functions.isModifyBookingAllowed(getJsonField(
                                                                                columnViewBookingDetailsResponse.jsonBody,
                                                                                r'''$.checkInDate''',
                                                                              ).toString())! &&
