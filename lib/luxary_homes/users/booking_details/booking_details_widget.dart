  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().updatePropertyBookingDetailsStruct(
        (e) => e..noOfBedrooms = FFAppState().BookingDetailsPage.bedRoomCount,
      );
      setState(() {});
      _model.cancellationPolicy = false;
      setState(() {});
    });
                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text:
                                                  'INR. ${FFAppState().BookingDetailsPage.pricePerRoom.toString()}',
                                              style: GoogleFonts.getFont(
                                                'Work Sans',
                                        ...
                                        children: [
                                          if ((_model.selectedFromToDates
                                            ...
                                            Align(
                                              alignment: AlignmentDirectional(
                                                  -1.0, -1.0),
                                              child: Text(
                                                '${_model.selectedFromToDates.length > 0 ? functions.daysCalculation(_model.selectedFromToDates.toList()).toString() : '0'}${functions.daysCalculation(_model.selectedFromToDates.toList()) > 1 ? ' Nights at ' : ' Night at '}${FFAppState().BookingDetailsPage.title}',
                                                style: GoogleFonts.getFont(
                                                  'Work Sans',
                                          ...
                                          Container(
                                            ...
                                            child:
                                              ...
                                              partiallyBookedDates: FFAppState()
                                                  .BookingDetailsPage
                                                  .partialBookedDates,
                                              availableFromDate: functions
                                              ...
                                              Theme(
                                                ...
                                                child: Checkbox(
                                                  ...
                                                  onChanged: (newValue) async {
                                                    ...
                                                    if (newValue!) {
                                                      FFAppState()
                                                          .updatePropertyBookingDetailsStruct(
                                                        (e) => e
                                                          ..isEntirePropertyBooking =
                                                              true,
                                                      );
                                                ...
                                                child: RichText(
                                                  ...
                                                  text: TextSpan(
                                                    children: [
                                                      ...
                                                      TextSpan(
                                                        text:
                                                            'You can choose only 2 guest per a room.',
                                                        style:
                                                            GoogleFonts.getFont(
                                                          'Work Sans',
                                                          ...
                                                          functions
                                                              .getPricePercentage(
                                                                  (_model.selectedFromToDates.length > 0
                                                                              ? functions.daysCalculation(_model.selectedFromToDates
                                                                                  .toList())
                                                                              : 0)
                                                                          .toDouble() *
                                                                      valueOrDefault<
                                                                        ...
                                                                        FFAppState().BookingDetailsPage.bedRoomCount *
                                                                            FFAppState().BookingDetailsPage.pricePerRoom,
                                                                        0.00,
                                                                      ),
                                                                  FFAppState()
                                                                      .BookingDetailsPage
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      if ((_model.selectedFromToDates.length >
                                              0) &&
                                          (functions.daysCalculation(_model
                                                  .selectedFromToDates
                                                  .toList()) >
                                          ...
                                          (e) => e
                                            ...
                                            ..totalPriceIncludingTax =
                                                functions.getPriceTotal(
                                                    ...
                                                    functions
                                                        .getPricePercentage(
                                                            (_model.selectedFromToDates.length >
                                                                            0
                                                                        ? functions.daysCalculation(_model
                                                                            .selectedFromToDates
                                                                            .toList())
                                    ...
                                    onPressed: () async {
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          'id': serializeParam(
                                            FFAppState()
                                                .bookingDetailsPropertyId,
                                            ParamType.JSON,
                                          ),
                                          'index': serializeParam(
                                            FFAppState().bookingDetailsIndex,
                                            ParamType.int,
                                          ),
                                        }.withoutNulls,
                                      );
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            mainAxisAlignment:
                                                                                MainAxisAlignment.spaceBetween,
                                                                            children: [
                                                                              if (FFAppState().BookingDetailsPage.sharedBookingAllowed == true)
                                                                                FlutterFlowIconButton(
                                                                                  borderColor: Colors.transparent,
                                                                                  borderRadius: 20.0,
                                                                                  buttonSize: 36.0,
                                                                              ...
                                                                              children: [
                                                                                if (FFAppState().BookingDetailsPage.sharedBookingAllowed == true)
                                                                                  FlutterFlowIconButton(
                                                                                    ...
                                                                                    onPressed: (FFAppState().BookingDetailsPage.guestsPerRoom == 1)
                                                                                        ? null
                                                                                        : () async {
                                                                                            FFAppState().updateBookingDetailsPageStruct(
                                                                                              (e) => e..incrementGuestsPerRoom(-1),
                                                                                            );
                                                                                            setState(() {});
                                                                                          },
                                                                                  ),
                                                                                Container(
                                                                                  ...
                                                                                  child: Align(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      padding: EdgeInsetsDirectional.fromSTEB(12.0, 0.0, 12.0, 0.0),
                                                                                      child: Text(
                                                                                        FFAppState().BookingDetailsPage.guestsPerRoom.toString(),
                                                                                        style: GoogleFonts.getFont(
                                                                                          'Work Sans',
                                                                                          color: FlutterFlowTheme.of(context).primaryText,
                                                                                          fontWeight: FontWeight.bold,
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        _model.selectedFromToDates.length > 0 ? dateTimeFormat('dd MMM yyyy', _model.selectedFromToDates.first) : 'dd MM yyyy',
                                                                                        style: GoogleFonts.getFont(
                                                                                          'Work Sans',
                                                                                          color: FlutterFlowTheme.of(context).primaryText,
                                                                                          fontWeight: FontWeight.w600,
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Padding(
                                                                                      padding: EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 10.0),
                                                                                      child: Text(
                                                                                        _model.selectedFromToDates.length > 0 ? dateTimeFormat('dd MMM yyyy', _model.selectedFromToDates.last) : 'dd MM yyyy',
                                                                                        style: GoogleFonts.getFont(
                                                                                          'Work Sans',
                                                                                          color: FlutterFlowTheme.of(context).primaryText,
                                                                                          fontWeight: FontWeight.w600,
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                FFAppState().propertyBookingDetails.noOfBedrooms > 1 ? 'Rooms' : 'Room',
                                                                                style: GoogleFonts.getFont(
                                                                                  'Work Sans',
                                                                                  color: FlutterFlowTheme.of(context).primaryText,
                                                                                  fontWeight: FontWeight.w500,
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                FFAppState().BookingDetailsPage.sharedBookingAllowed == true ? 'Guests Per Room' : 'Guests',
                                                                                style: GoogleFonts.getFont(
                                                                                  'Work Sans',
                                                                                  color: FlutterFlowTheme.of(context).primaryText,
                                                                                  fontWeight: FontWeight.w500,
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          if (FFAppState().propertyBookingDetails.isEntirePropertyBooking ==
                                                                              true)
                                                                            Flexible(
                                                                              child: Row(
                                                                                mainAxisSize: MainAxisSize.min,
