                                                ...
                                                InkWell(
                                                  ...
                                                  onTap: () async {
                                                    ...
                                                    if ((_model
                                                      ...
                                                      FFAppState()
                                                          .updateSearchPageParametersStruct(
                                                        (e) => e
                                                          ..index = 0
                                                          ..id = getJsonField(
                                                            (_model.filterOutputCopy1
                                              ...
                                              return Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  child: NewPropertyCardWidget(
                                                    key: Key(
                                                        'Key9bk_${propertyListingDataIndex}_of_${_model.listViewPagingController!.itemList!.length}'),
                                                                      ...
                                                                      children: [
                                                                        Flexible(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              FFAppState().searchCity != null && FFAppState().searchCity != '' ? FFAppState().searchCity : 'Any Place',
                                                                              style: GoogleFonts.getFont(
                                                                                'Work Sans',
                                                                                fontWeight: FontWeight.w500,
                                                                                fontSize: 16.0,
                                                                        ...
                                                                        Flexible(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              FFAppState().searchDates.length > 0 ? '${dateTimeFormat('MMMd', FFAppState().searchDates.first)} - ${dateTimeFormat('MMMd', FFAppState().searchDates.last)}' : 'Any Date',
                                                                              style: GoogleFonts.getFont(
                                                                                'Work Sans',
                                                                                fontWeight: FontWeight.w500,
                                                                                fontSize: 16.0,
                                                                        ...
                                                                        Flexible(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              FFAppState().searchGuests > 0 ? '${FFAppState().searchGuests.toString()} Guests' : 'Guests',
                                                                ...
                                                                onTap:
                                                                  ...
                                                                  _model.filterOutputForWeb =
                                                                    ...
                                                                    totalGuests:
                                                                        FFAppState()
                                                                            .searchGuests,
                                                                    checkInDate: FFAppState().searchDates.length >
                                                                            0
                                                                        ? dateTimeFormat(
                                                                            'yyyy-MM-dd',
                                                                            FFAppState().searchDates.first)
                                                                        : null,
                                                                    checkOutDate: FFAppState().searchDates.length >
                                                                            0
                                                                        ? dateTimeFormat(
                                                                            'yyyy-MM-dd',
                                                                  ...
                                                                  if ((_model
                                                                    ...
                                                                    FFAppState()
                                                                      ...
                                                                      (e) => e
                                                                        ...
                                                                        ..id =
                                                                            getJsonField(
                                                                          (_model.filterOutputForWeb?.jsonBody ??
                                                                              ''),
                                                                          r'''$.propertyBriefs[0].propertyId''',
                                                                        ),
                                                                    );
                                                                    ...
                                                                    _model.filterTextOutputForWeb =
                                                                      ...
                                                                      loaditemsCount:
                                                                          MediaQuery.sizeOf(context).width <= 500.0
                                                                              ? 4
                                                                              : 8,
                                                                      propertyTypeIds: functions.listTostrConversion(FFAppState()
                                                                          .userFilterPropertyType
                                                                          .toList()),
                                                                      locality:
                                                                          FFAppState()
                                                                    ...
                                                                    if ((_model
                                                                      ...
                                                                      FFAppState()
                                                                        ...
                                                                        (e) => e
                                                                          ...
                                                                          ..id =
                                                                              getJsonField(
                                                                            (_model.filterTextOutputForWeb?.jsonBody ??
                                                                                ''),
                                                                            r'''$.propertyBriefs[0].propertyId''',
                                                                          ),
                                                                      );
                                                                    ...
                                                                    if ((_model
                                                                      ...
                                                                      FFAppState()
                                                                        ...
                                                                        (e) => e
                                                                          ...
                                                                          ..id =
                                                                              getJsonField(
                                                                            (_model.filterText1ForWeb?.jsonBody ??
                                                                                ''),
                                                                            r'''$.propertyBriefs[0].propertyId''',
                                                                          ),
                                                                      );
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: Image
                                                                            .asset(
                                                                          'assets/images/Apartment_4X.png',
                                                                          fit: BoxFit
                                                                              .contain,
                                                                        ),
                                                                      ),
                                                                    ...
                                                                    if ((_model
                                                                      ...
                                                                      FFAppState()
                                                                        ...
                                                                        (e) => e
                                                                          ...
                                                                          ..id =
                                                                              getJsonField(
                                                                            (_model.filterText2ForWeb?.jsonBody ??
                                                                                ''),
                                                                            r'''$.propertyBriefs[0].propertyId''',
                                                                          ),
                                                                      );
                                                ...
                                                children: [
                                                  ...
                                                  FutureBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      final columnPropertyListingWithDatesResponse =
                                                          snapshot.data!;
                                                      return Column(
                                                        mainAxisSize:
                                                            MainAxisSize.min,
                                                            ...
                                                            child: Builder(
                                                              builder:
                                                                ...
                                                                final propertyListingData =
                                                                    getJsonField(
                                                                  columnPropertyListingWithDatesResponse
                                                                      .jsonBody,
                                                                  r'''$.propertyBriefs''',
                                                                ).toList();
                                                                return SingleChildScrollView(
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            key:
                                                                                Key('Keyoye_${propertyListingDataIndex}_of_${propertyListingData.length}'),
                                                                            propertyType:
                                                                                getJsonField(
                                                                              propertyListingDataItem,
                                                                              r'''$.propertyType''',
                                                                                  ...
                                                                                  ClipRRect(
                                                                                    ...
                                                                                    child: Image.network(
                                                                                      functions.getImage(
                                                                                          FFAppState().BaseUrl,
                                                                                          getJsonField(
                                                                                            columnFeaturedLocationsResponse.jsonBody,
                                                                                            r'''$.images[0].image''',
                                                                                          ).toString())!,
                                                                                ...
                                                                                child: RichText(
                                                                                  ...
                                                                                  text: TextSpan(
                                                                                    children: [
                                                                                      TextSpan(
                                                                                        text: getJsonField(
                                                                                          staggeredViewContentResponse.jsonBody,
                                                                                          r'''$[0].Title1''',
                                                                                        ).toString(),
                                                                                        style: GoogleFonts.getFont(
                                                                                          'Work Sans',
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  ...
                                                                                  style: GoogleFonts.getFont(
                                                                                    'Work Sans',
                                                                                    color: _model.onHover1 == true ? FlutterFlowTheme.of(context).primaryBackground : Color(0xFF5C5C5C),
                                                                                    fontWeight: FontWeight.w500,
                                                                                    fontSize: 24.0,
                                                                                  ),
                                                                                ),
                                                                                Flexible(
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      ...
                                                                                      style: GoogleFonts.getFont(
                                                                                        'Work Sans',
                                                                                        color: _model.onHover1 == true ? FlutterFlowTheme.of(context).primaryBackground : Color(0xFF3E3E3E),
                                                                                        fontSize: 18.0,
                                                                                      ),
                                                                                    ),
                                                                                  ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  ...
                                                                                  style: GoogleFonts.getFont(
                                                                                    'Work Sans',
                                                                                    color: _model.onHover2 == true ? FlutterFlowTheme.of(context).primaryBackground : Color(0xFF5C5C5C),
                                                                                    fontWeight: FontWeight.w500,
                                                                                    fontSize: 24.0,
                                                                                  ),
                                                                                ),
                                                                                Flexible(
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      ...
                                                                                      style: GoogleFonts.getFont(
                                                                                        'Work Sans',
                                                                                        color: _model.onHover2 == true ? FlutterFlowTheme.of(context).primaryBackground : Color(0xFF3E3E3E),
                                                                                        fontSize: 18.0,
                                                                                      ),
                                                                                    ),
                                                                                  ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  ...
                                                                                  style: GoogleFonts.getFont(
                                                                                    'Work Sans',
                                                                                    color: _model.onHover3 == true ? FlutterFlowTheme.of(context).primaryBackground : Color(0xFF5C5C5C),
                                                                                    fontWeight: FontWeight.w500,
                                                                                    fontSize: 24.0,
                                                                                  ),
                                                                                ),
                                                                                Flexible(
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      ...
                                                                                      style: GoogleFonts.getFont(
                                                                                        'Work Sans',
                                                                                        color: _model.onHover3 == true ? FlutterFlowTheme.of(context).primaryBackground : Color(0xFF3E3E3E),
                                                                                        fontSize: 18.0,
                                                                                      ),
                                                                                    ),
                                                                                  ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  ...
                                                                                  style: GoogleFonts.getFont(
                                                                                    'Work Sans',
                                                                                    color: _model.onHover4 == true ? FlutterFlowTheme.of(context).primaryBackground : Color(0xFF5C5C5C),
                                                                                    fontWeight: FontWeight.w500,
                                                                                    fontSize: 24.0,
                                                                                  ),
                                                                                ),
                                                                                Flexible(
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      ...
                                                                                      style: GoogleFonts.getFont(
                                                                                        'Work Sans',
                                                                                        color: _model.onHover4 == true ? FlutterFlowTheme.of(context).primaryBackground : Color(0xFF3E3E3E),
                                                                                        fontSize: 18.0,
                                                                                      ),
                                                                                    ),
                                                                                  ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  ...
                                                                                  style: GoogleFonts.getFont(
                                                                                    'Work Sans',
                                                                                    color: _model.onHover5 == true ? FlutterFlowTheme.of(context).primaryBackground : Color(0xFF5C5C5C),
                                                                                    fontWeight: FontWeight.w500,
                                                                                    fontSize: 24.0,
                                                                                  ),
                                                                                ),
                                                                                Flexible(
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      ...
                                                                                      style: GoogleFonts.getFont(
                                                                                        'Work Sans',
                                                                                        color: _model.onHover5 == true ? FlutterFlowTheme.of(context).primaryBackground : Color(0xFF3E3E3E),
                                                                                        fontSize: 18.0,
                                                                                      ),
                                                                                    ),
                                                                                  ),
