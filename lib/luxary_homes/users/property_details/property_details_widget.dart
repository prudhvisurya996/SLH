...
class _PropertyDetailsWidgetState extends State<PropertyDetailsWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().bookingDetailsPropertyId = widget.id!;
      FFAppState().bookingDetailsIndex = widget.index!;
      setState(() {});
    });
                                                                ...
                                                                child: PagedListView<
                                                                  ...
                                                                  pagingController:
                                                                    ...
                                                                    (nextPageMarker) =>
                                                                      ...
                                                                      pageSize:
                                                                          5,
                                                                      pageNo: functions.incrementOne(nextPageMarker.nextPageNumber) >=
                                                                              0
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            FFAppState().selectedDateRange =
                                                                                [];
                                                                            FFAppState().nightsForStay =
                                                                                0;
                                                                            FFAppState().update(() {});
                                                                            FFAppState().syncFisionCalendarDates =
                                                                            ...
                                                                            FFAppState().propertyDetailsRebuildCallBackHelper =
                                                                                FFAppState().propertyDetailsRebuildCallBackHelper + 1;
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            decoration:
                                                                              ...
                                                                              color: () {
                                                                                ...
                                                                                } else if ((FFAppState().bookingDetailsIndex == listingsIndex) && (_model.propertyId == null)) {
                                                                                  return Color(0xFFE8E7FF);
                                                                                } else {
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Image.network(
                                                                            _model.heroImage == null || _model.heroImage == ''
                                                                                ? functions
                                                                                    .initImg(
                                                                                        functions
                                                                                            .listDataConversion(getJsonField(
                                                                                          ...
                                                                                          onPressed: () async {
                                                                                            if (FFAppState().accessToken != null && FFAppState().accessToken != '') {
                                                                                              FFAppState().BookingDetailsPage = BookingDetailsPageStruct(
                                                                                                ...
                                                                                                availableFromDate: MicroserviceAvailabilityAPIsGroup.propertyDetailsCall.availableFrom(
                                                                                                  containerPropertyDetailsResponse.jsonBody,
                                                                                                ),
                                                                                                bookedDates: getJsonField(
                                                                                                  containerPropertyDetailsResponse.jsonBody,
                                                                                                ...
                                                                                                partialBookedDates: MicroserviceAvailabilityAPIsGroup.propertyDetailsCall.partiallyBookedDates(
                                                                                                  containerPropertyDetailsResponse.jsonBody,
                                                                                                ),
                                                                                                ...
                                                                                                image: functions
                                                                                                    .initImg(
                                                                                                        ...
                                                                                                        FFAppState().BaseUrl)
                                                                                                    ?.first,
                                                                                                addressDetails: '${MicroserviceAvailabilityAPIsGroup.propertyDetailsCall.plotNo(
                                                                                                  containerPropertyDetailsResponse.jsonBody,
                                                                                                )}, ${MicroserviceAvailabilityAPIsGroup.propertyDetailsCall.street(
                                                                                                  containerPropertyDetailsResponse.jsonBody,
                                                                                                )}, ${MicroserviceAvailabilityAPIsGroup.propertyDetailsCall.locality(
                                                                                              ...
                                                                                              FFAppState().bookingDetailsPropertyId = getJsonField(
                                                                                                containerPropertyDetailsResponse.jsonBody,
                                                                                                r'''$.propertyId''',
                                                                                              );
                                                                                              FFAppState().update(() {});
