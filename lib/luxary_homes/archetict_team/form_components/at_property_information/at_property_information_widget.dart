...
import 'at_property_information_model.dart';
export 'at_property_information_model.dart';

class AtPropertyInformationWidget extends StatefulWidget {
  const AtPropertyInformationWidget({super.key});

  @override
  State<AtPropertyInformationWidget> createState() =>
      _AtPropertyInformationWidgetState();
}

class _AtPropertyInformationWidgetState
    extends State<AtPropertyInformationWidget> {
  late AtPropertyInformationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AtPropertyInformationModel());
