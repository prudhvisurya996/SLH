...
import 'in_property_approve_model.dart';
export 'in_property_approve_model.dart';

class InPropertyApproveWidget extends StatefulWidget {
  const InPropertyApproveWidget({
    super.key,
  ...
  @override
  State<InPropertyApproveWidget> createState() =>
      _InPropertyApproveWidgetState();
}

class _InPropertyApproveWidgetState extends State<InPropertyApproveWidget> {
  late InPropertyApproveModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InPropertyApproveModel());
