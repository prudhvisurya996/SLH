...
import 'in_property_rejected_model.dart';
export 'in_property_rejected_model.dart';

class InPropertyRejectedWidget extends StatefulWidget {
  const InPropertyRejectedWidget({
    super.key,
  ...
  @override
  State<InPropertyRejectedWidget> createState() =>
      _InPropertyRejectedWidgetState();
}

class _InPropertyRejectedWidgetState extends State<InPropertyRejectedWidget> {
  late InPropertyRejectedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InPropertyRejectedModel());
