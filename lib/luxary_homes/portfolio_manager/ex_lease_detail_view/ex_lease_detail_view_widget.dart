...
import 'ex_lease_detail_view_model.dart';
export 'ex_lease_detail_view_model.dart';

class ExLeaseDetailViewWidget extends StatefulWidget {
  const ExLeaseDetailViewWidget({
    super.key,
          ...
          child: Column(
            ...
            children: [
              if ((widget.propertyStatus == 0) &&
                  (FFAppState().AdminLeasePropertyDetailView.assignedPhase ==
                      'PropertyInspector'))
                Padding(
                  padding:
                                ...
                                builder: (dialogContext) {
                                  return Dialog(
                                    ...
                                    child: Container(
                                      ...
                                      width: MediaQuery.sizeOf(context).width *
                                          0.8,
                                      child: AssignPiWidget(
                                        piLocation: widget.location!,
                              ...
                              await showDialog(
                                ...
                                builder: (dialogContext) {
                                  return Dialog(
                                    ...
                                    alignment: AlignmentDirectional(0.0, -1.0)
                                        .resolve(Directionality.of(context)),
                                    child: ExLeaseRejectReasonWidget(
                                      propertyId: widget.propertyId!,
                                      articleId: widget.articleId!,
                          ...
                          builder: (dialogContext) {
                            return Dialog(
                              ...
                              child: Container(
                                ...
                                child: AssignAtWidget(
                                  atLocation: widget.location!,
                                  propertyId: widget.propertyId!,
                                  articleId: widget.articleId!,
                                ),
                              ),
