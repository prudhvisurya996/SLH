...
import 'pm_dashboard_model.dart';
export 'pm_dashboard_model.dart';

class PmDashboardWidget extends StatefulWidget {
  const PmDashboardWidget({super.key});

  @override
  State<PmDashboardWidget> createState() => _PmDashboardWidgetState();
}

class _PmDashboardWidgetState extends State<PmDashboardWidget> {
  late PmDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PmDashboardModel());
                                        ...
                                        if (_model.selectPropertyType ==
                                          ...
                                          Expanded(
                                            child: wrapWithModel(
                                              ...
                                              updateCallback: () =>
                                                  setState(() {}),
                                              child: InListingDashboardWidget(),
                                            ),
                                          ),
                                        if (_model.selectPropertyType ==
                                            'Lease Request')
                                          Flexible(
                                            child: wrapWithModel(
                                              model:
                                                  _model.exLeaseDashboardModel,
                                              updateCallback: () =>
                                                  setState(() {}),
                                              child: ExLeaseDashboardWidget(),
                                            ),
                                          ),
                                      ],
                                    ),
