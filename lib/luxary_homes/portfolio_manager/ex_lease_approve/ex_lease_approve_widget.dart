...
import 'ex_lease_approve_model.dart';
export 'ex_lease_approve_model.dart';

class ExLeaseApproveWidget extends StatefulWidget {
  const ExLeaseApproveWidget({
    super.key,
  ...
  @override
  State<ExLeaseApproveWidget> createState() => _ExLeaseApproveWidgetState();
}

class _ExLeaseApproveWidgetState extends State<ExLeaseApproveWidget> {
  late ExLeaseApproveModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExLeaseApproveModel());
