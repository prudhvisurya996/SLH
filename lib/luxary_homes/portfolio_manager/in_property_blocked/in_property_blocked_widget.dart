...
import 'in_property_blocked_model.dart';
export 'in_property_blocked_model.dart';

class InPropertyBlockedWidget extends StatefulWidget {
  const InPropertyBlockedWidget({
    super.key,
  ...
  @override
  State<InPropertyBlockedWidget> createState() =>
      _InPropertyBlockedWidgetState();
}

class _InPropertyBlockedWidgetState extends State<InPropertyBlockedWidget> {
  late InPropertyBlockedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InPropertyBlockedModel());
