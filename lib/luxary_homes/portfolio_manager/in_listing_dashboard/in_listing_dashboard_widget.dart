...
import 'in_listing_dashboard_model.dart';
export 'in_listing_dashboard_model.dart';

class InListingDashboardWidget extends StatefulWidget {
  const InListingDashboardWidget({super.key});

  @override
  State<InListingDashboardWidget> createState() =>
      _InListingDashboardWidgetState();
}

class _InListingDashboardWidgetState extends State<InListingDashboardWidget> {
  late InListingDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InListingDashboardModel());
                      ...
                      Flexible(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 0.0, 12.0),
                          child: wrapWithModel(
                            model: _model.inPropertyBlockedModel,
                            updateCallback: () => setState(() {}),
                            child: InPropertyBlockedWidget(
                      ...
                      Flexible(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 0.0, 12.0),
                          child: wrapWithModel(
                            model: _model.inPropertyRejectedModel,
                            updateCallback: () => setState(() {}),
                            child: InPropertyRejectedWidget(
                              propertyStaus: _model.propertyStatus!,
                              pageNo: _model.pageNo!,
                              pageSize: _model.pageSize!,
                            ),
                      ...
                      Flexible(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 0.0, 12.0),
                          child: wrapWithModel(
                            model: _model.inPropertyApproveModel,
                            updateCallback: () => setState(() {}),
                            child: InPropertyApproveWidget(
                      ...
                      Flexible(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 0.0, 12.0),
                          child: wrapWithModel(
                            model: _model.inPropertyPendingModel,
                            updateCallback: () => setState(() {}),
                            child: InPropertyPendingWidget(
                              propertyStatus: _model.propertyStatus!,
                              pageNo: _model.pageNo!,
                              pageSize: _model.pageSize!,
                            ),
