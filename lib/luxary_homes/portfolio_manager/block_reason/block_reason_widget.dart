...
import 'block_reason_model.dart';
export 'block_reason_model.dart';
...
class _BlockReasonWidgetState extends State<BlockReasonWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BlockReasonModel());
          ...
          Flexible(
            child: Container(
              ...
              child: Padding(
                ...
                child: wrapWithModel(
                  model: _model.blockFormModel,
                  updateCallback: () => setState(() {}),
                  child: BlockFormWidget(
