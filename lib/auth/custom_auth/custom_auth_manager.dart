...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    hospitalityPlatformAuthUserSubject.add(
      HospitalityPlatformAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<HospitalityPlatformAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  HospitalityPlatformAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = HospitalityPlatformAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    hospitalityPlatformAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
HospitalityPlatformAuthUser? currentUser;
